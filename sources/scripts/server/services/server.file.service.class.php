...
class ASFileService {	
	...
	public static function compileDatabase( $data = [] , $desireddirectory = '' ){
		...
		$FILENAMES = [];
		$JSONDB = [];
		$dds = "/bis/sources/complist/$desireddirectory";
	...
	public static function autoBackUp(){
		//system("cmd /c C:\xampp\htdocs\bis\sources\scripts\server\routes\autobackup.bat'");
		//exec('start /B C:\xampp\htdocs\bis\sources\scripts\server\routes\autobackup.bat');
		//exec('c:\WINDOWS\system32\cmd.exe /c START C:\xampp\htdocs\bis\sources\scripts\server\routes\autobackup.bat');
		//system("c:\WINDOWS\system32\cmd.exe"); 
		//var_dump(shell_exec (" /c START C:\xampp\htdocs\bis\sources\scripts\server\routes\autobackup.bat"));
		//shell_exec('start  c:\WINDOWS\system32\cmd.exe /c START C:\xampp\htdocs\bis\sources\scripts\server\routes\autobackup.bat');
