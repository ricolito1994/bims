		...
		this.subpages = [
			{
				object : new HealthCenterDashboardController({
					...
					template : "/bis/sources/templates/section/health.center.dashboard.template.html",
					parent : this,
					isUpdate : true,
				}),
				isRendered : false,
			},
			{
				object : new HealthCenterRecordsController({
					...
					template : "/bis/sources/templates/section/health.center.records.template.html",
					parent : this,
					isUpdate : true,
				}),
				isRendered : false,
			},
			{
				object : new HealthCenterMapController({
					...
					template : "/bis/sources/templates/section/health.center.map.template.html",
					parent : this,
					isUpdate : true,
				}),
				isRendered : false,
