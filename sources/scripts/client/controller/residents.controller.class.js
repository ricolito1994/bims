...
export class ResidentsController extends Controller {
		...
		this.subpages = [
			{
				object : new ResidentsDashboardController({
					...
					template : `/${this.mainService.appname}/sources/templates/section/resident.dashboard.template.html`,
					parent : this,
					isUpdate : true,
				}),
				isRendered : false,
			},
			{
				object : new ResidentsSectionController({
					...
					template : `/${this.mainService.appname}/sources/templates/section/resident.section.template.html`,
					parent : this,
					isUpdate : true,
				}),
				isRendered : false,
			},
			{
				object : new ResidentsBusinessController({
					...
					controllerName : "ResidentSectionController",
					template : `/${this.mainService.appname}/sources/templates/section/resident.business.template.html`,
					parent : this,
					isUpdate : true,
				}),
				isRendered : false,
			},
			{
				object : new ResidentsPurokController({
					...
					template : `/${this.mainService.appname}/sources/templates/section/resident.purok.template.html`,
					parent : this,
					isUpdate : true,
				}),
				isRendered : false,
			},
			{
				object : new ResidentialMapController({
					...
					template : `/${this.mainService.appname}/sources/templates/section/residential.map.template.html`,
					parent : this,
					isUpdate : true,
				}),
				isRendered : false,
	...
	initialize(){
		let smb = new SideMenuBar ( {
			...
			template : `/${this.mainService.appname}/sources/templates/section/side.menu.bar.section.template.html`,
			parent : this,
			isUpdate : true,
			isRestored : true,
