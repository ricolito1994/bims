...
export class DashboardController extends Controller{
	...
	initialize(){
		/* let itemmasterdataWidget = new ItemMasterDataWidgetController ({
			...
			template : "/bis/sources/templates/section/itemmasterdata.widget.template.html",
			parent : this,
			isUpdate : true,
			args : []
		});
		...
		let itemmasterdataStatusWidget = new ItemMasterDataStatusWidgetController ({
			...
			template : "/bis/sources/templates/section/itemmasterdata.status.widget.template.html",
			parent : this,
			isUpdate : true,
			args : []
		});
