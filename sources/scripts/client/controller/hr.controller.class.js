		...
		this.subpages = [
			{
				object : new HRDashboardController({
					...
					template : "/bis/sources/templates/section/hr.dashboard.template.html",
					parent : this,
					isUpdate : true,
				}),
				isRendered : false,
			},
			{
				object : new HREmployeeController({
					...
					template : "/bis/sources/templates/section/hr.employee.template.html",
					parent : this,
					isUpdate : true,
				}),
				isRendered : false,
			},
			{
				object : new HREmployeeAttendanceController({
					...
					template : "/bis/sources/templates/section/hr.employee.attendance.template.html",
					parent : this,
					isUpdate : true,
				}),
				isRendered : false,
